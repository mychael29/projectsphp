...
<section>
    <div class="container">
      <div class="row">
        <div class="col-xs12">
        <?php  if (!isset($_SESSION['username'])) : ?>
        // va el controller de usuarios para que este verifica que hay o no sesion, caso contrario.. enviar al login
        // Aqui va el login, o el controller de usuarios
        <?php endif ?>

        <?php  if (isset($_SESSION['username'])) : ?>
        // va el controller de agregar averia y el reporte de este con todo lo q mas pide
